...
```html 
    <script crossorigin="anonymous"   type="module" src='https://unpkg.com/@atlasling/readalong@latest/dist/read-along/read-along.esm.js'></script>
    <script crossorigin="anonymous"   nomodule src='https://unpkg.com/@atlasling/readalong@latest/dist/read-along/read-along.js'></script>
```
